...
[![Documentation](https://docs.rs/bounded-static/badge.svg)](https://docs.rs/bounded-static/0.3.0)
[![Crate](https://img.shields.io/crates/v/bounded-static.svg)](https://crates.io/crates/bounded-static/0.3.0)

# Bounded Static
An experimental crate that defines the [`ToBoundedStatic`](https://docs.rs/bounded-static/0.3.0/bounded_static/trait.ToBoundedStatic.html) 
and [`IntoBoundedStatic`](https://docs.rs/bounded-static/0.3.0/bounded_static/trait.IntoBoundedStatic.html) traits, 
the [`ToStatic`](https://docs.rs/bounded-static/0.3.0/bounded_static/derive.ToStatic.html) macro and provides impls 
...
Refer to the crate [`documentation`](https://docs.rs/bounded-static/0.3.0/bounded_static) for details and examples.
